    ...
    def update(self, events, screen: pygame.Surface, animate: bool, delta_time: float) -> None:
        ...
        if keys_pressed[pygame.K_d]:
            if keys_pressed[pygame.K_LSHIFT]:
                self.dict_actor.set_component_states('run')
            elif keys_pressed[pygame.K_LCTRL]:
                self.dict_actor.set_component_states('crouch')
            else:
                self.dict_actor.set_component_states('walk')
            ...
            self.dict_actor.set_component_states('idle')
